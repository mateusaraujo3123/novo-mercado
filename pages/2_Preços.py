...
# ==========================================
st.set_page_config(page_title="Tabela de Preços - Portal da Vila", page_icon="📦", layout="wide")

# ==========================================
# MENU LATERAL ADAPTADO
# ==========================================
st.sidebar.markdown("# 🏪 Menu Mercadinho")
st.sidebar.radio("Navegação", ["Dashboard Inicial", "Gestão de Fiados", "Tabelas de Preço", "Histórico de Logs"], index=2, label_visibility="collapsed")
...
# Autentica direto a cada recarregamento para eliminar o RefreshError de vez
...
# ==========================================
@st.cache_data(ttl=5) # TTL baixo para atualizar quase instantaneamente
...
def salvar_produtos(df):
    ...
    st.cache_data.clear() # Limpa a memória para forçar a gravação real no Google Drive
...
aba_lista, aba_novo, aba_excluir = st.tabs([
    "📋 Preços Praticados", "➕ Novo Produto", "❌ Remover Produto"
])
# ==========================================
